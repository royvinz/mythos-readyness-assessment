...
const I18N = {
  fr: {
    ...
    api_timeout: "Appel API interrompu après",
    api_pending: "Appel API en cours…",
    ...
    ingest_parsing: "Analyse de la réponse JSON…",
    ...
    ingest_select_file: "Sélectionnez un fichier avant de lancer l'analyse.",
    ingest_file_ready: "Fichier prêt à être analysé.",
    ingest_no_file: "Aucun fichier sélectionné.",
    ingest_running: "Analyse en cours…",
    ingest_progress: "Avancement",
    ingest_response_truncated: "La réponse du modèle a été coupée avant la fin. Réessayez ou réduisez le fichier.",
    ingest_json_invalid: "La réponse du modèle n'est pas un JSON valide :",
    ingest_no_json: "aucun objet JSON détecté.",
  ...
  en: {
    ...
    api_timeout: "API call stopped after",
    api_pending: "API call in progress…",
    ...
    ingest_parsing: "Parsing JSON response…",
    ...
    ingest_select_file: "Select a file before starting the analysis.",
    ingest_file_ready: "File ready for analysis.",
    ingest_no_file: "No file selected.",
    ingest_running: "Analysis running…",
    ingest_progress: "Progress",
    ingest_response_truncated: "The model response was cut off before completion. Try again or reduce the file.",
    ingest_json_invalid: "The model response is not valid JSON:",
    ingest_no_json: "no JSON object detected.",
